# The Cortex Node — VoltHacks 2026

> A physical interrupt for a disappearing thought.

This VoltHacks-specific extension is an honest hardware digital twin of an ESP32 cognitive-capture device. It adds a simulated ESP32, INMP441 microphone, capture button, status telemetry, serial packets, wiring documentation, and flashable firmware. Hardware readings are explicitly simulated; no physical validation is claimed.
